...
compile_error!("\"executor-single-thread\" and \"threading\" are mutually exclusive!");
...
#[cfg(feature = "executor-thread")]
use executor_thread::{PRIORITY, STACKSIZE};

#[cfg(feature = "executor-thread")]
#[riot_rs_macros::thread(autostart, stacksize = STACKSIZE, priority = PRIORITY)]
fn init() {
