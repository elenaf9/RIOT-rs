...
const THREAD_FLAG_EXECUTOR_WAKEUP: ThreadFlags = 0x01;
...
fn __pender(context: *mut ()) {
    ...
    thread_flags::set(thread_id, THREAD_FLAG_EXECUTOR_WAKEUP);
}
...
impl Executor {
    ...
    pub fn run(&'static mut self, init: impl FnOnce(Spawner)) -> ! {
        ...
        loop {
            ...
            thread_flags::wait_any(THREAD_FLAG_EXECUTOR_WAKEUP);
        }
    }
}
