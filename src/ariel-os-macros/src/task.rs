    ...
    let expanded = if attrs.autostart {
        ...
        quote! {
            ...
            fn #new_function_name(
                spawner: #ariel_os_crate::Spawner,
                mut peripherals: &mut #ariel_os_crate::arch::OptionalPeripherals,
            ) {
            ...
            #[#ariel_os_crate::reexports::embassy_executor::task]
            #task_function
        }
    } else {
        ...
        quote! {
            #[#ariel_os_crate::reexports::embassy_executor::task(pool_size = #pool_size)]
            #task_function
        }
    };
